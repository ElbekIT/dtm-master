...
import { CreditCard, Upload, CheckCircle2, AlertTriangle, Copy, ShieldCheck, Clock, FileText, ChevronRight } from "lucide-react";
...
export default function PremiumBuy({ currentUser, onSuccess, isBlocker = false }: PremiumBuyProps) {
